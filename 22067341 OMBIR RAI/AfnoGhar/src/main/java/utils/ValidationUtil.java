...
public class ValidationUtil {
    ...
    public static boolean isCateogry(String category) {
        // Convert the gender to lowercase and compare with "customer" and "admin" ignoring case
        return category != null && (category.equalsIgnoreCase("cusotmer") || category.equalsIgnoreCase("admin"));
    }
